...
public class Controladora {
    ...
    public void guardar(String nombreMasco, String raza, String color, String observaciones, String alergico, String atenEsp, String nombreDuenio, String celDuenio) {
        // Creamos duenio y asignamos values
        Duenio duenio = new Duenio();
        duenio.setNombre(nombreDuenio);
        duenio.setCelDuenio(celDuenio);
        
        // Creamos mascota y asignamos values usando los setters
        ...
        // Solicitamos a la persistencia que guarde en la BD el duenio y la mascota
