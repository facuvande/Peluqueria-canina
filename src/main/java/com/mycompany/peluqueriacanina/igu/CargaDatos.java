...
public class CargaDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // Le pasamos los datos a la logica, que ella se encargue de crear los objetos y luego enviarselo a la persistencia para que lo guarde
        control.guardar(nombreMasco, raza, color, observaciones, alergico, atenEsp, nombreDuenio, celDuenio);
        
        JOptionPane optionPane = new JOptionPane("Se realizo el guardado correctamente.");
